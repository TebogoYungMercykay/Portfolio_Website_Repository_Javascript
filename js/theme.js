...
document.addEventListener('DOMContentLoaded', function() {
	...
	// Apply the stored theme preference (if any) after dark mode is set as default
	window.addEventListener('load', function() {
		...
		if (defaultTheme && defaultTheme != "N/A") {
			...
			// Ensure dark mode is applied even if no preference exists
	...
	// Fixed: Swapped the variable assignments to match the correct modes
